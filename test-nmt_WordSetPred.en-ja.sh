...
python -u ./LSTMEncDecAttn_WordSetPred.py \
   ...
   --init-model        ${LSTM_MODEL_DIR}/en-ja/iwslt.tok.nlz.en-ja.model.epoch13 \
   --setting           ${LSTM_MODEL_DIR}/iwslt.tok.nlz.en-ja.model.setting \
   --beam-size         ${BEAM} \
   --max-length        150 \
   --red-model         ${MEDIA_DIR}/model/WordSetPred.en-ja.model.epoch${RED_EP} \
   --red-weight        ${red_w} \
